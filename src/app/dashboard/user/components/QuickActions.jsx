  ...
  return (
    <div className="bg-white shadow-sm rounded-lg border border-gray-200 mb-8">
      ...
      <button 
          ...
          className="w-full flex items-center justify-center px-4 py-3 bg-green-600 text-white rounded-md hover:bg-green-700 transition duration-150"
        >
        ...
        <button 
          onClick={() => router.push('/dashboard/user/results')}
          className="w-full flex items-center justify-center px-4 py-3 bg-white border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition duration-150"
        >
